Rails.application.routes.draw do
  ...
  get 'code_docs', to: 'open_ai_code_analysis#code_docs', as: 'code_docs'
  post 'open_ai_code_analysis/generate_code_docs', to: 'open_ai_code_analysis#generate_code_docs', as: 'genrate_code_docs'
end
